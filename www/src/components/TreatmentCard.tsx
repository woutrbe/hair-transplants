	...
	return (
      ...
      <div className="col-span-4 sm:col-span-1 flex flex-col justify-center items-center ">
        ...
        <div className="text-sm text-muted-foreground">
          <Link href={treatment.review.source} target="blank" className="hover:underline">{treatment.review.score} stars, {treatment.review.totalReviews} reviews</Link>  
        </div>
      </div>
      ...
      <div className="col-span-4 sm:col-span-1 flex flex-col justify-center items-center">
        <div className="text-2xl font-bold text-primary mb-1">${treatment.price.usd_price}</div>
          <div className="text-sm text-muted-foreground">
